...
export function CtaSection() {
  ...
  return (
    <Section id="cta" className="bg-brand text-white">
      ...
      <Reveal index={1}>
        <p className="mb-8 max-w-xl text-center text-base text-white/90 sm:text-lg">
      ...
      <Reveal index={2}>
        <button
          type="button"
          onClick={() => goTo(0)}
          className="rounded-full bg-accent px-6 py-3 text-sm font-semibold text-ink transition hover:brightness-95"
        >
          回到首页
        </button>
      </Reveal>
